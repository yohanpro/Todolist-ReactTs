			...
			<CardBody>
				<div className="list__main" onClick={() => toggle('Edit')}>
					...
					<div className="list-due mt-4">
						<div>Completed</div>
						<span className="list-task__dueDate">{completed ? 'Yes' : 'No'}</span>
					</div>
				</div>
				<div className="list__iconArea">
					<AiFillEdit className="list-icon list__edit" size="25" color="rgba(113,113,113,1)" />
					<BsTrash className="list-icon list__delete" size="25" color="rgba(113,113,113,1)" />
				</div>
			</CardBody>
